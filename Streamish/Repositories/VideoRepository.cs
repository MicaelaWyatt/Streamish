    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
        ...
        public Video GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                          SELECT v.Id, v.Title, v.Description, v.Url, v.DateCreated, v.UserProfileId, up.[Name], up.Email, up.ImageUrl, up.DateCreated AS UserProfileDateCreated
                            FROM Video v
                            JOIN UserProfile up ON v.UserProfileId = up.Id
                           WHERE v.Id = @Id;";
        ...
        //Add a GetVideoByIdWithComments() method to your VideoRepository that gets a single Video and includes that Video's comments.
        ...
        public List<Video> GetAllVideosFromUserById(int id)
        {
            using (var conn = Connection)
            {
                conn.Open();
